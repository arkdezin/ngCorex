...
src/styles/ngcorex.utilities.css (optional)
```
...
You can configure this in `ngcorex.config.ts`:
...
```
src/styles/ngcorex.utilities.css
```
...
- **ngcorex.config.ts** → _engine wiring and configuration_
- **generated CSS** → _compiled output_
- **generated utilities** → _utility classes (optional)_
