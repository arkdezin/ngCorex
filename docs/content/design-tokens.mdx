...
Defines opacity values for transparency.
...
Opacity values are validated for type and format.

---

### Borders

Defines border-related tokens.
...
Border values are validated for type and format.

---

### Gradients

Defines gradient definitions.
...
Gradient values are validated for type and format.

---

### Icons

Defines icon sizing tokens.
...
Icon values are validated for type and format.
